...
import { Download, Shield, Copy, ExternalLink, Plus, Trash2, ArrowUp, ArrowDown } from 'lucide-react';
import type { RecipeStep } from '../services/supabaseAdmin';
...
export const VisualRecipeBuilder: React.FC<VisualRecipeBuilderProps> = ({
  ...
  const getStepTitle = (action: string) => {
    switch (action) {
      case 'stream_extract': return '1. Descarga y Extracción en Vivo';
      case 'add_defender_exclusion': return '2. Exclusión en Windows Defender';
      case 'apply_crack': return '3. Aplicar Medicina / Parche';
      case 'create_shortcut': return '4. Crear Acceso Directo';
